...
//update prof
Route::get('updatep/{id}',[\App\Http\Controllers\TeachersController::class,'updatep']);
Route::post('updatep/updateProf',[\App\Http\Controllers\TeachersController::class,'updateProf']);
